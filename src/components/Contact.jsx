        ...
        >
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-6 gap-y-4">
            ...
            <motion.a
              ...
              className="group flex items-center gap-2 text-gray-200 text-lg transition-colors duration-300 px-4 py-2 rounded-full hover:bg-rose-400"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 fill-rose-300 group-hover:fill-[#08122f] transition-colors duration-300">
              ...
              <span className="text-rose-300 group-hover:text-[#08122f] transition-colors duration-300">Email</span>
            </motion.a>
            ...
            >
              ...
              <span className="text-rose-300 group-hover:text-[#08122f] transition-colors duration-300">LinkedIn</span>
            </motion.a>
            ...
            >
              ...
              <span className="text-rose-300 group-hover:text-[#08122f] transition-colors duration-300">GitHub</span>
            </motion.a>
            ...
            <motion.a
              ...
              className="group flex items-center gap-2 text-gray-200 text-lg transition-colors duration-300 px-4 py-2 rounded-full hover:bg-rose-400"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-rose-300 group-hover:fill-[#08122f] transition-colors duration-300">
              ...
              <span className="text-rose-300 group-hover:text-[#08122f] transition-colors duration-300">WhatsApp</span>
            </motion.a>
