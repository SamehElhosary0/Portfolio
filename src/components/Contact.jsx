            ...
            {[
              {
                ...
                label: "Email",
                svg: (
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 transition-colors duration-300">
              ...
              },
              {
                ...
                target: "_blank",
                svg: (
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 transition-colors duration-300">
              ...
              <motion.a
                ...
                className="group flex items-center gap-2 text-lg transition-colors duration-300 px-4 py-2 rounded-full"
                style={{ color: "var(--text-secondary, #e2e8f0)" }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "var(--accent, #A3E635)";
                  e.currentTarget.style.color = "var(--bg-primary, #08122f)";
                  const svg = e.currentTarget.querySelector("svg");
                  if (svg) svg.style.fill = "var(--bg-primary, #08122f)";
                  const span = e.currentTarget.querySelector("span");
                  if (span) span.style.color = "var(--bg-primary, #08122f)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = "transparent";
                  e.currentTarget.style.color = "var(--text-secondary, #e2e8f0)";
                  const svg = e.currentTarget.querySelector("svg");
                  if (svg) svg.style.fill = "var(--accent-light, #BEF264)";
                  const span = e.currentTarget.querySelector("span");
                  if (span) span.style.color = "var(--accent-light, #BEF264)";
                }}
              >
                <span style={{ fill: "var(--accent-light, #BEF264)" }}>{item.svg}</span>
                <span style={{ color: "var(--accent-light, #BEF264)" }}>{item.label}</span>
              </motion.a>
            ))}
          </div>
        </motion.div>
